...
export const works: Work[] = [
    {
        ...
        description:
            "A modern, fully responsive developer portfolio built with React, TypeScript, Tailwind CSS, and GSAP animations. Showcasing my skills, projects, and contact info with smooth UI/UX.",
        technologies: [
            "React",
            "TypeScript",
            "Tailwind CSS",
